...
badd +252 /opt/utf8/source/utf8/checked.h
badd +41 /opt/utf8/source/utf8/core.h
badd +0 utf8_string.cpp
badd +0 /opt/utf8/source/utf8/unchecked.h
argglobal
silent! argdel *
argadd driver.cpp
set stal=2
...
setlocal fen
silent! normal! zE
let s:l = 64 - ((29 * winheight(0) + 21) / 42)
...
setlocal fen
silent! normal! zE
let s:l = 314 - ((29 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
314
...
wincmd t
set winminheight=1 winminwidth=1 winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 85 + 79) / 158)
exe 'vert 2resize ' . ((&columns * 72 + 79) / 158)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 111 - ((21 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
setlocal fen
silent! normal! zE
let s:l = 100 - ((18 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
normal! 0
tabedit /opt/utf8/source/utf8/unchecked.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal fen
silent! normal! zE
let s:l = 112 - ((19 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
...
setlocal fen
silent! normal! zE
let s:l = 361 - ((25 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
361
...
setlocal fen
silent! normal! zE
let s:l = 22 - ((13 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
setlocal fen
silent! normal! zE
let s:l = 74 - ((23 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
setlocal fen
silent! normal! zE
let s:l = 63 - ((36 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
